...
public class DetectActivitiesService extends Service implements GoogleApiClient.OnConnectionFailedListener {
        ...
        Awareness.FenceApi.updateFences(
                ...
                .setResultCallback(new ResultCallback<Status>() {
                    ...
                    public void onResult(@NonNull Status status) {
                        if(status.isSuccess()) {
                            Log.d("MYTEST", "교통수단 펜스 성공적으로 등록됨");
                        } else {
    ...
    public void onConnectionFailed(@NonNull ConnectionResult connectionResult) {
        Log.d("MYTEST","Google API Client Connection fail");
    }

    class myServiceHandler extends Handler {
        @Override
        public void handleMessage(android.os.Message msg) {
            Toast.makeText(DetectActivitiesService.this, "service 동작중", Toast.LENGTH_LONG).show();
        }
    };
...
//                                + intent.getAction());
            ...
            Log.d("MYTEST","키확인 : " + fenceState.getFenceKey()+";;;"+ FENCE_KEY);
            if (TextUtils.equals(fenceState.getFenceKey(), FENCE_KEY)) {
                ...
                switch (fenceState.getCurrentState()) {
                    ...
                    case FenceState.FALSE:
                        state = 2;
                        fenceStateStr = "운송수단 사용을 종료하였습니다. 반경 200m 내의 병원을 펜스로 등록합니다.";
                        break;
                ...
                setDetectedHospitalService(state);
